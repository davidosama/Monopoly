...
public class Board {
    ArrayList <normalCity> normalCities = new ArrayList<normalCity>(); // 22 cities
    ArrayList <RailRoad> railRoads = new ArrayList<RailRoad>(); // 4 railroads
    ArrayList <Company> companies = new ArrayList<Company>(); // 2 companies
